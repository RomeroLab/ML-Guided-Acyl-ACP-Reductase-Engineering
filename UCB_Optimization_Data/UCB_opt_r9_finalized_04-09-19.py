...
Modified and renamed on 04/09/19
Selected regularization parameter to maximize the correllation coefficient to curb overfitting.
...
csvfile='RL08_data_04-07-19.csv'
r=str(9)
...
#        print('!!!!Error!!!!!')
#        
#    if lowest_distance(blockseq)<=2:  ## Number of allowable block substitutions
...
chosen=UCB_tools.select_new_sequences(Xact,Yact,Xact_pred,active_seq,lam,chimeras,chimera2AA,num_sequences=10,show_iters='False')
