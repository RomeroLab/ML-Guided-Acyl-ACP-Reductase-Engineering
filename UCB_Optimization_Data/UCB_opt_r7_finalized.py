...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 14:58:26 2019
UCB Optimization Round 7.

Notes: 
    Trained model on active ACR sequences
    Modified choice of lambda to use the max correlation coefficient rather than minimum error squared since this resulted in a better model (and the error squared is not too much greater than the minimum)
...
csvfile='RL08_data_03-11-19.csv'
r=str(7)
